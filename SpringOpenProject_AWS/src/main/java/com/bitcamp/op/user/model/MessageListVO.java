...
public class MessageListVO {
		...
		public MessageListVO(List<MessageVO> messageList, int messageTotalCount, int currentPageNumber,
		...
		public String toString() {
			return "MessageListVO [messageTotalCount=" + messageTotalCount + ", currentPageNumber=" + currentPageNumber
