...
<!--
------------------------------------------------------------
 주간 박스오피스 REST 호출 - 자바스크립트로 호출하는 방식 예제
본자바스크립트로 직접 호출하는 경우 발급키가 공개되므로 서버호출 방식을 권장함
------------------------------------------------------------
-->
    <%
    // 파라메터 설정
	String targetDt = request.getParameter("targetDt")==null?"20180724":request.getParameter("targetDt");				//조회일자
...
$(function(){
	var kobisService = new KobisOpenAPIRestService("b5b210981bae3978236982b181c85bfb");
	var resJson = null;
	try{
